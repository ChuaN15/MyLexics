...
namespace MyLexics
{
    [Activity(Label = "SukukataSelectionActivity", Theme = "@style/Theme.Menu", Icon = "@mipmap/icon", ScreenOrientation = ScreenOrientation.Landscape)]
    public class SukukataSelectionActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            // Create your application here
            SetContentView(Resource.Layout.SukukataSelection);
            ...
            foreach (vokalKonsonan vk in vokalList)
            {
                ...
                {
                    Intent intent = new Intent(this, typeof(SukukataVideoActivity));
        ...
        private async void loadButtonImage()
        {
            ...
            bitmapToDisplay = await decodeImage.LoadScaledDownBitmapForDisplayAsync(Resources, Resource.Drawable.Kenanli_Sukukata_title, options, 250, 250);
